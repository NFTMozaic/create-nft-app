...
export const KNOWN_WALLETS = [
  {
    name: 'polkadot-js',
    title: 'Polkadot.js',
    downloadLink: 'https://polkadot.js.org/extension/',
  },
  {
    name: 'talisman',
    title: 'Talisman',
    downloadLink: 'https://talisman.xyz/',
  },
  {
    name: 'subwallet-js',
    title: 'SubWallet',
    downloadLink: 'https://subwallet.app/',
  },
  {
    name: 'nova',
    title: 'Nova Wallet',
    downloadLink: 'https://novawallet.io/',
  },
  {
    name: 'enkrypt',
    title: 'Enkrypt',
    downloadLink: 'https://www.enkrypt.com/',
  },
];
