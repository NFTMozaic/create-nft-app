...
export const WalletModal: React.FC = () => {
  ...
  useEffect(() => {
    const handleOpenModal = () => {
      setIsOpen(true);
      // If already connected, show accounts directly
          ...
          {!showAccounts ? (
            ...
            <>
              ...
              >
                ...
                <span style={{ flex: 1, textAlign: 'left' }}>{wallet.title}</span>
                ...
                {!wallet.installed && (
                  <span style={{ fontSize: '14px', color: '#999' }}>Not installed</span>
                )}
                              </button>
              ))}
                ...
                accounts.map((account, index) => (
                  <button
                    ...
                    style={{
                      ...
                      padding: '12px',
                      marginBottom: '8px',
                      border: selectedAccount?.address === account.address ? '2px solid #3b82f6' : '1px solid #e5e5e5',
                      borderRadius: '6px',
                      backgroundColor: 'white',
                      cursor: 'pointer',
                      display: 'flex',
